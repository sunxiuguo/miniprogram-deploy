...
program
    .option('-t, --doctor', 'Check if the deploy configuration file is correct')
    .option('-i, --init', 'Init the deploy configuration file')
    .option('-u, --upload', 'Upload the miniprogram bundle')
